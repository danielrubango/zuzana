...
<div class="md:float-right md:w-2/3 bg-blue-lightest px-1 md:px-8 py-6 mb-20" data-aos="fade-up">
    ...
    <p class="mb-6">All images used on this website are from <a href="https://unsplash.com"> Unsplash.</a></p>
</div>
